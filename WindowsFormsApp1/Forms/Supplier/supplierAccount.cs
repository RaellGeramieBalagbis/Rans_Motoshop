...
namespace WindowsFormsApp1.Forms
{
    public partial class supplierAccount : Form
    {
        ...
        private void ManageAccounts_Load(object sender, EventArgs e)
        {
            ...
            string query = "SELECT * FROM Supplier WHERE Supplier.Supplier_FirstName = '" +frm_login.firstnameHome+"'";
            ...
            OleDbCommand cmd = new OleDbCommand(query, Repository.Connection.conn);
                ...
                {
                    dataGridProducts.Rows.Add(row[0], row[9], row[1], row[2], row[3], row[4], row[5], row[6], row[7], row[8]);
                }
